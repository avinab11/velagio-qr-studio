      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed text-[14px] md:text-[15px] font-light">
            ...
            <p>
              Enjoy free, unlimited dynamic and static QR code generation. No subscriptions. No sign-ups. No expirations. 100% free forever. Update your destination anytime, track performance, and maintain full control with dynamic QR codes - all at no cost.
            </p>
            <p>
